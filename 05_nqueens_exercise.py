...
class QueensProblemAttack(QueensProblem):
    ...
    def next_states(self, state: ChessBoard) -> Generator[ChessBoard, None, None]:
        pass
        # Idea: Very similar to next_states of QueensProblemNoAttack
...
class QueensProblemRowByRow(QueensProblem):
    ...
    def next_states(self, state: RowByRowState) -> Generator[RowByRowState, None, None]: # type: ignore[override]
        ...
        # Idea: Very similar to previous implementations of next_sates
